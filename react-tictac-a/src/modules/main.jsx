...
const calcWinner = (squares) =>{
	for(let i = 0 ; i <9 ; i++){
		if( i< 3 && squares[i] && squares[i] === squares[i+3] && squares[i] === squares[i+6]) {
			return squares[i]
		} else if(i % 3 === 0 &&squares[i] && squares[i] === squares[i+1] && squares[i] === squares[i+2]) {
			return squares[i]
		} else if( i===4 && squares[i] && squares[i] === squares[i-4] && squares[i] === squares[i+4]) {
			return squares[i]
		} else if( i===4 && squares[i] && squares[i] === squares[i-2] && squares[i] === squares[i+2]) {
			return squares[i]
		}
	}
	return null ;
	...
	// for(let i = 0 ; i <9 ; i++){
	// 	if(i <3 ) {
	// 		if( i <squares[i] && squares[i] === squares[i+3] && squares[i] === squares[i+6]) {
	// 			return squares[i]
	// 		}
	// 	}
	// 	if(i % 3 === 0) {
	...
	// 			return squares[i]
	// 		} else if(squares[i] && squares[i] === squares[i-2] && squares[i] === squares[i+2]) {
	// 			return squares[i]
	// 		}
	// 	}
	// 	return null ;
